 ...
 * @author basic
 */
public class AddNewAccommodation extends javax.swing.JFrame {
  private Country current_country_;
  /**
   * Creates new form AddNewAccommodation
   */
  ...
  private void initComponents() {
    ...
    destinations_list_label.setText("Accommodation name:");
    ...
    destinations_list_label1.setText("Accommodation description:");
    ...
    layout.setHorizontalGroup(
      ...
      .addGroup(layout.createSequentialGroup()
        ...
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
          ...
          .addComponent(destinations_list_label1, javax.swing.GroupLayout.Alignment.LEADING)
          .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
              ...
              .addGap(90, 90, 90)
              .addComponent(city_combo_box, javax.swing.GroupLayout.PREFERRED_SIZE, 264, javax.swing.GroupLayout.PREFERRED_SIZE)))
  ...
  private void add_buttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_add_buttonMouseClicked
    ...
    try {
      ...
      if(city_combo_box.getItemCount() >= 0) {
        System.out.println("ODJE1");
        String name = desc_field1.getText();
        String description = desc_field.getText();
        if(name.equals("")) {
          JOptionPane.showMessageDialog(null, "Cannot add an accommodation without a name.", "Error!", JOptionPane.ERROR_MESSAGE);
        } else if(description.equals("")) {
          JOptionPane.showMessageDialog(null, "Cannot add an accommodation without description.", "Error!", JOptionPane.ERROR_MESSAGE);
        } else {
          ...
          System.out.println("ODJE2");
          if(UserController.getInstance().addAccommodation(city, accommodation)) {
            System.out.println("ODJE3");
            JOptionPane.showMessageDialog(null, "Accommodation added!", "Success!", JOptionPane.INFORMATION_MESSAGE);
            desc_field.setText("");
            desc_field1.setText("");
        ...
        JOptionPane.showMessageDialog(null, "Cannot add, there is no accommodation selected.", "Error!", JOptionPane.ERROR_MESSAGE);
      }
    } catch (Exception e) {
      System.out.println("AddNewAccommodation: " + e.getMessage());
    }
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(AddNewAccommodation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new AddNewAccommodation().setVisible(true);
      }
    });
  }
